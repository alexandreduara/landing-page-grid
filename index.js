...
menu__button.addEventListener('click', ()=>{
    ...
    if (menu__image.getAttribute('src') == './images/icon-hamburger.svg'){
        menu__image.setAttribute('src','./images/icon-close.svg');
    }
    else{
        menu__image.setAttribute('src', './images/icon-hamburger.svg');
    }
})